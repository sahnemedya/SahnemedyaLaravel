        ...
        <div class="max-width menulu">
            <div class="text">
                ...
                <div class="contact-form-container">
                    ...
                    <form class="iletisim-formu" action="{{route("insanKaynaklariPost")}}" method="post"
                        ...
                        <div class="upload-container item-100">
                            <div class="upload-area" id="uploadArea">
                                <div class="upload-icon">📄</div>
                                <div class="upload-text">CV'ni buraya sürükle veya tıklayarak seç.</div>
                                <div class="upload-subtext">
                                    Resim, PDF veya Word dosyası yükleyebilirsiniz. (JPG, PNG, PDF, DOC, DOCX)
                                </div>
                                <input type="file" id="fileInput" class="file-input" name="cv"
                        ...
                        <input class="item-100" type="text" name="konu" placeholder="Departman Giriniz">
    ...
    <script>
        ...
        const isValidFileType = (file) => {
            ...
            return validTypes.includes(file.type) ||
                /\.(jpg|jpeg|png|pdf|doc|docx)$/i.test(file.name);
        };
        ...
        const addFiles = (newFiles) => {
            for (let file of newFiles) {
                if (isValidFileType(file)) {
                    ...
                    alert(`"${file.name}" desteklenmeyen bir dosya türüdür. Lütfen JPG, PNG, PDF, DOC veya DOCX dosyası seçin.`);
                }
            }
            displayFiles();
        };
        ...
        // Sayfa yüklendiğinde varsayılan davranışı önle
