                    ...
                    @foreach($contacts as $contact)
                        <div class="office-card">
                            <div class="office-header">
                                <div class="city-icon">
                                    <img src="{{asset("images/site/icons/beyaz/anasayfa.svg")}}" alt="">
                                </div>
                                <div class="office-title">{{$contact->city}}</div>
                            </div>

                            <div class="contact-item">
                                <div class="contact-icon">
                                    <img src="{{asset("images/site/icons/beyaz/konum.svg")}}" alt="">
                                </div>
                                <div class="contact-info">
                                    <div class="contact-label">Adres</div>
                                    <div class="contact-value">{{$contact->address}} {{$contact->state}}
                                        / {{$contact->city}}</div>
                                </div>
                            </div>
                            ...
                            <div class="contact-item">
                                <div class="contact-icon">
                                    <img src="{{asset("images/site/icons/beyaz/telefon.svg")}}" alt="">
                                </div>
                                <div class="contact-info">
                                    ...
                                    <div class="contact-value">
                                        <a href="tel:{{$contact->phone}}">
                                            <a href="tel:{{$contact->phone}}"
                                               onclick="telefonpAramasi(event,'tel:{{$contact->phone}}')">
                                                {{--                            +9{{$contacts->phone}}--}}
                            ...
                            <div class="contact-item">
                                <div class="contact-icon">
                                    <img src="{{asset("images/site/icons/beyaz/whatsapp.svg")}}" alt="">
                                </div>
                                <div class="contact-info">
                                    <div class="contact-label">WhatsApp</div>
                                    <div class="contact-value">
                                        <a href="https://wa.me/+9{{$contact->phone}}?text=Randevu%20almak%20istiyorum"
                                           id="whatsapp-message"
                                           onclick="whatsAppAramasi(event,'https://wa.me/+9{{$contact->phone}}?text=Bilgi%20almak%20istiyorum')">
                                            {{--                            +9{{$contacts->phone}}--}}
                            ...
                            <div class="contact-item">
                                <div class="contact-icon">
                                    <img src="{{asset("images/site/icons/beyaz/footer-mail.svg")}}" alt="">
                                </div>
                                <div class="contact-info">
                                    <div class="contact-label">E-posta</div>
                                    <div class="contact-value">
                                        <a href="mailto:{{$contact->email}}" class="yazi">{{$contact->email}}</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="map-container">
                                ...
                                &nbsp;
                                <iframe src="{{$contact->map}}" width="610" height="450" style="border:0;"
